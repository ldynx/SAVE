...
class Transformer3DModel(ModelMixin, ConfigMixin):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, timestep=None, return_dict: bool = True):
        ...
        if len(encoder_hidden_states.shape) == 4:
            encoder_hidden_states = rearrange(encoder_hidden_states, 'b f n c -> (b f) n c', f=video_length)
        ###################################
        else:
...
class FrameAttention(Attention):
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None, video_length=None):
        ...
        if isinstance(self.processor, XFormersAttnProcessor):
            ...
            slice_size = batch_size_attention // 16
