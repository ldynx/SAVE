...
def text_under_image(image: np.ndarray, text: str, text_color: Tuple[int, int, int] = (0, 0, 0)):
    ...
    cv2.putText(img, text, (text_x, text_y ), font, 2, text_color, 2)
    return img


def view_images(images, num_rows=1, offset_ratio=0.02, set_title=None, save_dir=None):
    ...
    if save_dir is None:
        ...
        pil_img.save(os.path.join(save_dir, f"{set_title}.png"))
